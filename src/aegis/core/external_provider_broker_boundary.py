        ...
        guidance.append(
            {
                ...
                "base_url_env_var": item.get("base_url_env_var") or "",
                "default_base_url_guidance": item.get("default_base_url_guidance") or "",
                "suggested_models": tuple(item.get("suggested_models") or ()),
                "api_key_placeholder": item["api_key_placeholder"],
                "model_placeholder": item["model_placeholder"],
                "base_url_placeholder": item.get("base_url_placeholder") or "",
