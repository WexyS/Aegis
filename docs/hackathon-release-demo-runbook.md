# Hackathon release Demo Runbook

Decision: `HACKATHON_RELEASE_GOLDEN_PATH_SMOKE_RUNBOOK`

This runbook describes the verified judge-facing Hackathon release Golden Path. It is
...
2. Click the `Hackathon release` sidebar tab.
3. Confirm `Hackathon release Mission Control` is visible.
