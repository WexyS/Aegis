...
| `C:\Users\nemes\.cache\lm-studio\models` | missing | legacy/alternate LM Studio path |
| `C:\Users\nemes\.ollama\models` | exists, empty | `0 B` | legacy/reference only; user currently uses LM Studio |
...
| --- | --- |
| Model Provider / Local LLM Readiness v1 | blocked while disk remains critical unless external storage is approved |
| Model Lifecycle / VRAM Budget Design v1 | may proceed as design-only; implementation needs disk and VRAM inventory |
| Memory Governance / Memory OS Design v1 | design can proceed; persistent memory storage needs retention and growth policy |
| MCP / Tool Gateway Readiness v1 | design can proceed; tool caches/artifacts need per-tool retention |
...
`LLM Authority Boundary Contract v1`
