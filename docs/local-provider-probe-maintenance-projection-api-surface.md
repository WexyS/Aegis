# Local Provider Probe Maintenance Projection API Surface
## Decision
...
This API surface consumes the projection readiness contract added in the prior readiness pass. It uses the maintenance projection validator for supplied metadata fixtures and preserves the same non-authority invariants.
