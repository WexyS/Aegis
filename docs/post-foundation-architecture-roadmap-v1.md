# Post-Foundation Architecture Roadmap v1
...
Aegis has a Foundation v1 baseline accepted as
...
Readiness v1`, not another design skeleton.
...
### Phase 2: Context Compiler Read-Only Integration Readiness v1
...
### Phase 3: Policy-as-Code Extension v1
...
### Phase 4: Capability Lease Design v1
...
### Phase 5: MCP/Tool Gateway Readiness v1
...
### Phase 6: Memory Governance / Memory OS Design v1
...
### Phase 7: Model Router Readiness v1
...
### Phase 8: Skill/Plugin Architecture Design v1
...
- Link to `docs/foundation-baseline-v1.md`.
...
- Correct future Context Compiler wording to `Context Compiler Read-Only
  Integration Readiness v1`, because the skeleton already exists.
...
- `git rev-parse HEAD`
- `git log -1 --oneline`
- `git tag --list foundation-v1-baseline`
- `git diff --check`
