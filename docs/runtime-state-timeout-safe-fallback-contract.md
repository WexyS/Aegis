# Runtime State Timeout Safe Fallback Contract
...
The decision shape always keeps these authority fields false:
...
The contract does not click, kill a browser, kill a process, refresh a page,
