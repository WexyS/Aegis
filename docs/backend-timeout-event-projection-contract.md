# Backend Timeout Event Projection Contract
...
## Relationship To Timeout Safe Fallback
Runtime State Timeout / Safe Fallback Contract classifies timeout conditions.
