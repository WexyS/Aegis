# Aegis Foundation V1 Baseline

- Baseline name: `foundation-v1-baseline`
...
1. Historical Evidence/Replay Debt Cleanup Design v1
2. App Registry relevance/noise reduction v1
3. Electron transient JSON parse/500 debugging v1, only if it recurs
4. Post-Foundation Architecture Roadmap v1
5. Context Compiler design skeleton v1, only after policy/foundation baseline is stable
