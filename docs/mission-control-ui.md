...
Decision: MISSION_CONTROL_UI_WITH_REAL_BACKEND_APIS

Mission Control RC UI adds a judge-facing Hackathon release tab for the three RC
backend tracks:
...
S4.1 adds a scoped premium visual layer for the Hackathon release surface only. The
...
3. Open the Aegis UI and select `Hackathon release`.
