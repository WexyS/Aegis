# Hackathon release Demo Script

Decision: `HACKATHON_RELEASE_DEMO_SCRIPT`

This is a 3-5 minute judge-facing script for the narrow Hackathon release. Keep the
...
"I start in the Hackathon release tab. The Golden Path strip shows the path the demo
...
"Next, Memory OS Core shows candidate memory proposals. A candidate is not
...
"AutoPilot Core is a read-only audit and report producer. It gives the
