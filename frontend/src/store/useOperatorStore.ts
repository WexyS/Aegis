...
function mapBackendDecisionPreview(backendPreview: OperatorBackendRoutePreview): OperatorDecisionPreview {
  return {
    ...
    capabilityAssessment: {
      contract: backendPreview.capability_assessment.contract,
      classification: backendPreview.capability_assessment.classification,
      rationale: backendPreview.capability_assessment.rationale,
      boundary: backendPreview.capability_assessment.boundary,
      source: backendPreview.capability_assessment.source,
      readOnly: backendPreview.capability_assessment.read_only,
      previewOnly: backendPreview.capability_assessment.preview_only,
      deterministic: backendPreview.capability_assessment.deterministic,
      nonAuthoritative: backendPreview.capability_assessment.non_authoritative,
      nonExecuting: backendPreview.capability_assessment.non_executing,
      nonApproving: backendPreview.capability_assessment.non_approving,
      nonVerifying: backendPreview.capability_assessment.non_verifying,
      actionPerformed: backendPreview.capability_assessment.action_performed,
      modelCallPerformed: backendPreview.capability_assessment.model_call_performed,
      providerCallPerformed: backendPreview.capability_assessment.provider_call_performed,
      commandExecuted: backendPreview.capability_assessment.command_executed,
      toolExecuted: backendPreview.capability_assessment.tool_executed,
      browserActionPerformed: backendPreview.capability_assessment.browser_action_performed,
      filesystemMutationPerformed: backendPreview.capability_assessment.filesystem_mutation_performed,
      memoryWritten: backendPreview.capability_assessment.memory_written,
      approvalGranted: backendPreview.capability_assessment.approval_granted,
      evidenceCreated: backendPreview.capability_assessment.evidence_created,
      verifierRun: backendPreview.capability_assessment.verifier_run,
      executionAuthorized: backendPreview.capability_assessment.execution_authorized,
    },
