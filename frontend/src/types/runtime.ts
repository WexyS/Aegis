...
export interface EvidenceAudit {
  ...
  current_unverified_completed_count?: number;
  historical_unverified_completed_count?: number;
  unknown_era_unverified_completed_count?: number;
  verifier_check_failure_count?: number;
