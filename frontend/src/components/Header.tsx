...
export const Header = () => {
  ...
  return (
    <header className="h-14 shrink-0 border-b border-white/10 flex items-center justify-between gap-3 px-3 sm:px-4 lg:px-5 bg-background/85 backdrop-blur-md z-40">
      <div className="flex items-center gap-4 min-w-0">
        <div className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.12em] text-foreground/85 min-w-0">
          <Activity size={14} className="text-accent" />
          <span className="truncate">Aegis Runtime</span>
